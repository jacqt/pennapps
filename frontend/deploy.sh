...
SSH_SERVER="deployer@api.getcashew.com"
TAR_DEST="~/oatpay-tars"
SITE_DIR="/srv/venmo_site/static_site"
...
ssh $SSH_SERVER "rm -rf $SITE_DIR/oatpay && mkdir $SITE_DIR/oatpay && mv $TAR_DEST/dist/* $SITE_DIR/oatpay"
echo -e "$GREEN Deployed tar ball to $SITE_DIR/oatpay $NORMAL"
